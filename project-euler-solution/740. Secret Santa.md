...
Let p(xy) be the probability of the process fail when the first person picks up gifts from the x-th person and the y-th person. Then q(3) = 1/3 * p(1) + 1/3 * p(2) + 1/3 * p(3)
